...
This site has the **GPL 2.1 License**. Feel free to take the format (particularly the color scheme), but don't use any of my data.

Original template by Cobidev can be found [here](https://github.com/cobidev/gatsby-simplefolio).
